...
toolkit checkout before planning.
...
plus a `filed-followups:` line listing every issue number you filed. A
summary without the parts table is an incomplete exit (the claim's review
sends it back).
